...
export default function PomodoroTimer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-violet-300 to-pink-50">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="flex flex-col items-center justify-center gap-6">
          <u><h1 className="text-4xl font-bold text-blue-800">Pomodoro Timer</h1></u>
...
`}{" "}
  ...
  <h1 className="text-1xl">Developed By :</h1>
  <h1 className="text-1xl">Hareem Jaweid</h1>
</div>
      </Card>
    </div>
  );
